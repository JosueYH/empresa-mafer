        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h4 class="page-title">Administrador del Sistema MAFER</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="listadmin.php">Lista de Administradores</li>
                  <li class="breadcrumb-item"><a href="addadmin.php">Agregar Administrador</a></li>
                </ol>
              </nav>
            </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <input type="text" class="form-control" placeholder="Escribe el nombre del Administrador" aria-label="Recipient's username" aria-describedby="basic-addon2">

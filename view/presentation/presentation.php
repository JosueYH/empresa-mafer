<?php
require $_SERVER['DOCUMENT_ROOT'] .('/empresa-mafer/public/template/head/header.php'); // Ruta absoluta desde la raíz del servidor
...
<?php 
require $_SERVER['DOCUMENT_ROOT'] .('/empresa-mafer/public/template/head/footer.php'); // Ruta absoluta desde la raíz del servidor
